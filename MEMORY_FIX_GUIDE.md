...
## Problem Summary
The `canonization` plugin crashes Obsidian on large vaults (15,000+ files) due to O(n²) algorithms that weren't designed for scale.
...
O:\Theophysics_Master\THEOPHYSICS\.obsidian\plugins\canonization\
```
